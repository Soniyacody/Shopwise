...
//@desc update exisiting product by id
// @access Private/admin
router.put("/:id", protect, admin, async (req, res) => {
  try {
    ...
    if (product) {
      ...
      // Save updated proudct in database
...
// @desc Retrive lastest 8 products-Creation date
// @access Public
...
// @desc Rtreive similar products based on the current products gender and category
// @access public

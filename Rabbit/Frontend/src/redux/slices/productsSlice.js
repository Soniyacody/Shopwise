...
//Async Thunk to ftech smiliar products
...
export const fetchSmiliarProducts = createAsyncThunk(
...
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchSmiliarProducts.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(fetchSmiliarProducts.fulfilled, (state, action) => {
        state.loading = false;
        state.similarProducts = action.payload;
      })
      .addCase(fetchSmiliarProducts.rejected, (state, action) => {
        state.loading = false;
        state.error = action.error.message;
      });
  },

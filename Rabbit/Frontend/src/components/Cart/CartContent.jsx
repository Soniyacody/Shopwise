                    ...
                    <div key={index} className="flex items-start justify-between py-4 border-b">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <button onClick={() => handleRemoveFromCart(product.productId, product.size, product.color, userId, guestId)} className='mt-10'><RiDeleteBin3Line className='h-6 w-6  text-red-600' /></button>
                            </div>
                        </div>
                    </div>
                ))

            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
                <div>
                    ...
                    <form action="" className="flex ">
                        <input type="email" className="rounded-l-md p-3 w-ful text-sm border-t border-l border-b border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" required placeholder='Enter your Email' />
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-4 mb-6">
                        <a href="https://facebook.com" target='_blank' rel="noopener noreferrer" className='hover:text-gray-600'> <TbBrandMeta className='h-5 w-5' /> </a>
                        <a href="https://facebook.com" target='_blank' rel="noopener noreferrer" className='hover:text-gray-600'> <IoLogoInstagram className='h-5 w-5' /> </a>
                        <a href="https://facebook.com" target='_blank' rel="noopener noreferrer" className='hover:text-gray-600'> <RiTwitterXLine className='h-4 w-4' /> </a>
                    </div>
                    <p className="text-gray-500">Call Us</p>
                    <p className=''>
                        <FiPhoneCall className='inline-block mr-2' />0123456789
                    </p>
                </div>
            </div>
            {/* Footer Copyright */}
            <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
                <p className='text-gray-500 text-sm tracking-tighter text-center'>© 2025, Rabbit Ecommerce. All Rights Reserved </p>
            </div>
        </footer>
    )
}

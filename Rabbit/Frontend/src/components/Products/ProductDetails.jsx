...
import { fetchProductDetails, fetchSmiliarProducts } from '../../redux/slices/productsSlice';
...
const ProductDetails = ({ productId }) => {
    ...
    useEffect(() => {
        if (productFetchId) {
            ...
            dispatch(fetchSmiliarProducts({ id: productFetchId }));
        }
                ...
                <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-1/2 md:ml-10">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex gap-2 mt-2">
                                    {selectedProduct.sizes.map((size) => (
                                        <button key={size} className={`px-4 py-2 rounded border ${selectedSize === size ? "border-4 bg-black text-white" : ""} `}
                            ...
                            <button onClick={handleAddToCart} className={`bg-black text-white py-2 px-6 rounded w-full mb-4 ${isButtonDisabled ? "cursor-not-allowed opacity-70" : "hover:bg-gray-800"}`}>{isButtonDisabled ? "Adding...." : "ADD TO CART"}</button>
                            <div disabled={isButtonDisabled} className="mt-10 text-gray-700">
